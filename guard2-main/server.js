...
client.ownerst = ["827414963571654687", "461875665654906882", "904344023056146452", "489865427682328588","839452086454190127","728919150990327810"]; // KURUCU
client.evulate = []
...
client.botAccounts = ["863038982380322826","838111911068958740","901368248392634418","837976538283769857","837296161953808394","838116354774532117"] // Güvenli bot ID
client.botroles = ["863038982380322826","838111911068958740","901368248392634418","837976538283769857","837296161953808394","838116354774532117"] // YLER GİDİNCE YETKİSİ GİTMİYECEK BOTLARIN ID
let kanal = "905467517236023394" // LOG KANAL
let ustKanal = "781661216077512714" // YETKİSİ YETMEYİNCE BLABLA

client.on("ready", () => {
    client.user.setActivity("Revelion ❤️ Fexy.");
...
client.on("guildUpdate", async (oldGuild, newGuild) => {
    await newGuild.fetchAuditLogs({
        ...
        if (oldGuild.name !== newGuild.name) {
            newGuild.setName("✰ R E V E L I O N ")
...
client.login("ODM4MTExOTExMDY4OTU4NzQw.YI2Wig.DxX3LQhP1vISoKirCUdcTj1QTvA");